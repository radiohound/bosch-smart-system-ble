...
Every address that **returned data** to a BLE request on our BDU3740 — these are the addresses
Bosch's own **Flow app** reads, reverse-engineered, and confirmed by us **actually pulling a value
back over Bluetooth**. They are the **161 of Remko's ~895** that answer over BLE; the rest are
USB-only or command-type (full sweep: [`data/ble_accessibility.csv`](../data/ble_accessibility.csv),
grammar in [`BLE-ACCESS.md`](BLE-ACCESS.md)).

**Confidence:** **✓** = scaling + meaning byte-verified (detailed in the map above) · **◐** =
**read, not yet verified** — the bike returns a value and Remko's registry names it, but we haven't
byte-confirmed the scaling on *this* bike. **Stream:** *auto* = pushed passively while connected ·
*req* = answers only when explicitly requested.

*19 verified · 142 read-but-unverified · 161 reachable total. Names are Remko
Weijnen's `bes3-reader` registry labels.*

### DriveUnit (60)

| id | field | unit | stream | conf |
|----|-------|:----:|:------:|:----:|
...
| `98-05` | HARDWARE_SOFTWARE_VERSION | — | auto | ◐ |
| `98-06` | SOFTWARE_VERSION | — | auto | ◐ |
| `98-07` | BOOTLOADER_SOFTWARE_VERSION | — | auto | ◐ |
| `98-0C` | ASSIST_MODE_SHORT_NAMES | — | auto | ◐ |
| `98-0D` | ASSIST_MODE_LONG_NAMES | — | auto | ✓ |
| `98-0E` | ASSIST_MODE_COLORS | — | auto | ✓ |
...
| `98-18` | ODOMETER | m | auto | ✓ |
| `98-19` | POWER_ON_TIME | s | auto | ◐ |
| `98-1A` | BIKE_NOT_DRIVING | — | auto | ◐ |
| `98-1D` | ROAD_SLOPE | — | auto | ◐ |
| `98-25` | WALK_ASSIST_CONFIGURATION_OEM | — | auto | ◐ |
| `98-26` | WALK_ASSIST_CONFIGURATION | — | auto | ◐ |
| `98-27` | PRODUCT_LINE | — | auto | ◐ |
| `98-28` | REAR_WHEEL_CIRCUMFERENCE_OEM | mm | auto | ◐ |
| `98-29` | REAR_WHEEL_CIRCUMFERENCE_USER | mm | auto | ✓ |
...
| `98-42` | MAXIMUM_ASSISTANCE_SPEED_IBD | km/h | auto | ◐ |
| `98-46` | UDAM_MODIFICATION_POSSIBLE | — | auto | ◐ |
| `98-4E` | ACTIVE_ASSIST_MODES | — | auto | ✓ |
| `98-55` | BIKE_CATEGORY | — | auto | ◐ |
| `98-57` | REACHABLE_RANGE | — | auto | ✓ |
| `98-5E` | OEM_BIKE_ID | — | auto | ◐ |
| `98-5F` | OEM_MANUFACTURING_LOCATION | — | auto | ◐ |
| `98-61` | OEM_MANUFACTURING_DATE | — | auto | ◐ |
| `98-65` | BIKE_NOT_MOVING | — | auto | ◐ |
| `98-68` | AVAILABLE_ASSIST_MODES_LOWER | — | req | ✓ |
| `98-69` | REQUIRED_ASSIST_MODES_LOWER | — | auto | ◐ |
| `98-6C` | OEM_BRAND_NAME | — | auto | ◐ |
| `98-6D` | POWER_ON_TIME_WITH_MOTOR_SUPPORT | s | auto | ◐ |
| `98-70` | DRIVE_UNIT_FEATURE_PROPERTIES_RELEASE2 | — | auto | ◐ |
| `98-71` | DRIVE_UNIT_FEATURE_PROPERTIES_RELEASE3 | — | auto | ◐ |
| `98-74` | MAXIMUM_AVAILABLE_MOTOR_POWER | — | auto | ✓ |
| `98-75` | OEM_BIKE_MODEL_ID | — | auto | ◐ |
| `98-7A` | DRIVE_UNIT_FEATURE_PROPERTIES_RELEASE4 | — | auto | ◐ |
| `98-7D` | REGIO_SPEED_CONFIGURATION | — | auto | ◐ |
| `98-80` | DRIVE_UNIT_STATIC_FEATURE_PROPERTIES | — | auto | ◐ |
| `98-84` | PRESENT_PCB_TEMPERATURE | °C | req | ◐ |
| `98-8B` | ASSIST_MODE_LIMITS | — | auto | ◐ |
| `98-8C` | MAXIMUM_CONFIGURED_DISCHARGE_CURRENT | A | auto | ◐ |
...
| `80-86` | SOFTWARE_VERSION | — | auto | ◐ |
| `80-87` | BOOTLOADER_SOFTWARE_VERSION | — | auto | ◐ |
| `80-88` | STATE_OF_CHARGE | % | auto | ✓ |
| `80-8B` | PRESENT_PACK_TEMPERATURE | °C | auto | ✓ |
| `80-91` | REMAINING_ENERGY_FOR_RIDER | Wh | auto | ✓ |
| `80-92` | REMAINING_ENERGY | Wh | auto | ✓ |
| `80-93` | MAXIMUM_ALLOWED_DISCHARGE_CURRENT | A | req | ✓ |
| `80-96` | NUMBER_OF_FULL_CHARGE_CYCLES | — | auto | ◐ |
| `80-9B` | PRODUCT_NAME | — | auto | ✓ |
| `80-9C` | DELIVERED_WH_OVER_LIFETIME | Wh | auto | ✓ |
| `80-A4` | MANUFACTURING_DATE | — | auto | ◐ |
| `80-B0` | NUMBER_OF_FULL_CHARGE_CYCLES_ON_BIKE | cycles | auto | ◐ |
| `80-B4` | TOTAL_ENERGY | Wh | auto | ◐ |
| `80-BC` | SYSTEM_STATE_OF_CHARGE_FOR_RIDER | % | auto | ◐ |
| `80-C2` | FEATURE_PROPERTIES_RELEASE4 | — | auto | ◐ |
| `80-C5` | INSTANCE_REMAINING_ENERGY_FOR_RIDER | Wh | auto | ✓ |
| `80-CA` | INSTANCE_STATE_OF_CHARGE_FOR_RIDER | % | auto | ◐ |
| `80-D2` | PRESENT_FET_TEMPERATURE | °C | req | ◐ |
| `80-D7` | DELIVERED_AH_OVER_LIFETIME | Ah | auto | ◐ |
| `80-D8` | STATE_OF_HEALTH | % | auto | ◐ |
| `80-D9` | SYSTEM_TOTAL_ENERGY_FOR_RIDER | Wh | auto | ◐ |
| `80-E2` | TOTAL_CAPACITY | Ah | auto | ✓ |
...
| `A1-84` | BIKE_ID | — | req | ◐ |
| `A1-86` | BIKE_NAME | — | auto | ✓ |
| `A1-98` | MAXIMUM_BATTERIES_AVAILABLE_AT_SOME_POINT | — | req | ◐ |
| `A1-9B` | LOCK_SOUND_ENABLED | — | auto | ◐ |
| `A1-C1` | INTERNAL_BATTERY_VOLTAGE | — | req | ◐ |
...
| `A2-41` | ACTIVITY_ID | — | auto | ◐ |
| `A2-44` | TIME_ZONE_OF_ACTIVITY | min | auto | ◐ |
| `A2-4C` | AVERAGE_HEART_RATE | bpm | auto | ◐ |
| `A2-4D` | MAXIMUM_HEART_RATE | bpm | auto | ◐ |
| `A2-50` | AUTOMATIC_ACTIVITY_RESET | — | auto | ◐ |
| `A2-52` | ASSIST_MODE_USAGE_TOTAL | — | auto | ◐ |
| `A2-53` | ASSIST_MODE_USAGE_WITH_MOTOR_SUPPORT_ACTIVE | — | req | ◐ |
| `A2-55` | BRAKE_EVENTS | — | auto | ◐ |
